...
//definizione dei vettori delle misure;
vector <float> xi;
vector <float> yi;

//definizione variabili calcolo
float intercetta = 0;
float coefficiente_angolare = 0;
int numerosita_campione = 0;

//definizione variabili input file
ifstream file_in_yi;
...
//controllo uguaglianza dimensione vettori
if (xi.size() != yi.size()){
