...
//variabili per la stampa dei risultati della regressione
ofstream file_out_a;
...
//file incertezze sulle misure ordinate
...
//file valore misure sulle ordinate
...
//file valore misure sulle ascisse
...
//controllo che tutti i vettori abbiamo la stessa dimensione
//incertezza ordinate - ordinate
if (syi.size() != yi.size()) {
  cout << "Errore" << endl;
...
//calcolo del vettore ascisse*ordinate
...
// cout << "xi^2 / syi^2    " << sum_xi_pow2_diviso_syi_pow2 << endl;
...
//cout << "yi / syi^2    " << sum_yi_diviso_syi_pow2 << endl;
...
//cout << "xi / syi^2    " << sum_xi_diviso_syi_pow2 << endl;
...
//cout << "xiyi / syi^2    " << sum_xiyi_diviso_syi_pow2 << endl;
...
//cout << "somma 1 / syi^2    " << sum_1_diviso_syi_pow2 << endl;
...
//calcolo b (coefficiente angolare)
...
//cout parametri della regressione lineare
cout << endl;
