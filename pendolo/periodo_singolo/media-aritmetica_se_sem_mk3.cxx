...
file_out_media.open ("media_aritmetica.txt", ofstream::out | ios_base::ate);
...
//------------------------------------------------------------------------------------------------------------------------
file_out_se.open ("se.txt", ofstream::out | ios_base::ate);
...
file_out_se.close();
//------------------------------------------------------------------------------------------------------------------------
file_out_sem.open ("sem.txt", ofstream::out | ios_base::ate);
...
file_out_sem.close();
//------------------------------------------------------------------------------------------------------------------------
file_out_parametri.open ("parametri.txt", ofstream::out | ios_base::ate);
